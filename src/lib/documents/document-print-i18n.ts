...
export const printDocStrings = {
  th: {
    ...
    docDraft: 'DRAFT',
    docCancelled: 'ยกเลิก',
    cancellationReasonLabel: 'เหตุผลยกเลิก',
    awaitingDocNo: 'รอออกเลขที่เมื่อยืนยันฉบับจริง',
    replacesNotice: 'แทนที่เลขที่',
    replacementNotice: 'ถูกแทนที่ด้วยเลขที่',
    validUntil: 'ใช้ได้ถึง',
    currency: 'สกุลเงิน',
    subtotal: 'รวมเป็นเงิน',
    lineSubtotal: 'รวมบรรทัด',
    vat: 'ภาษีมูลค่าเพิ่ม',
    wht: 'หัก ณ ที่จ่าย',
    ...
    noMilestones:
      'กำหนดการชำระและวงเงินตามเอกสารรับวางบิลอ้างอิง PO — การโอน/จ่ายดำเนินการในขั้นบัญชี ไม่ระบุงวดชำระในใบสั่งซื้อนี้',
    ...
    noLines: 'ไม่มีรายการ',
    whtRateNote: '(ฐานก่อน VAT ตามสัดส่วนยอดสุทธิ PO — สุทธิจ่าย = ยอดรวม VAT − หัก ณ ที่จ่าย; งวดจ่ายผ่านใบรับวางบิล)',
  ...
  en: {
    ...
    awaitingDocNo: 'Document no. assigned when issued',
    replacesNotice: 'Replaces',
    replacementNotice: 'Replaced by',
    ...
    noMilestones:
      'Payment schedule and amounts are handled via vendor billing documents referencing this PO; settlement is done in accounting — installments are not recorded on this PO.',
    milestoneDue: 'Due',
    ...
    whtRateNote: '(pre-VAT base per PO total ratio; net = total incl. VAT − WHT; installments via vendor bills)',
