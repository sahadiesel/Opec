 ...
 *
 * ## สแตนบายฝั่งจ่ายลูกจ้าง (payroll cost) — แยกจากบิลลูกค้า
 * SB มาตรฐาน = **8 ชม.** · จ่าย = baseH × ชม.ที่ลง × standbyMult (ปกติ 0.5)
 * ตัวอย่าง D=1,400 → SB 8 ชม. = 100×8×0.5 = **400** (ครึ่งของส่วน 8 ชม.ปกติ ไม่ใช่ครึ่งแพ็ก 700)
