...
export const RateConditionSchema = z.object({
  id: z.string().optional(),
  parentType: z.enum(['SALES_CONTRACT', 'LABOR_COST_CONTRACT', 'GLOBAL']),
  parentId: z.string().min(1, 'Parent ID is required'),
  appliesTo: z.enum(['WORKER', 'POSITION', 'CATEGORY', 'ALL']),
  workerCategoryId: z.string().optional().nullable(),
  positionId: z.string().optional().nullable(),
  siteId: z.string().optional().nullable(),
  workMode: z.enum(['ONSHORE', 'OFFSHORE']).optional().nullable(),
  eventType: z.enum([
