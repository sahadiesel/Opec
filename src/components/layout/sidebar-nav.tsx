...
const ACCOUNTING_DOCUMENT_SUBSECTIONS: Array<{
...
}> = [
  {
    ...
    icon: FileBadge,
    items: [
      { key: 'draft_invoices', title: 'การออกใบแจ้งหนี้ (Invoice)', href: '/draft-invoices', icon: FileText },
...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        key: 'draft_invoices',
        title: 'การออกใบแจ้งหนี้ (Invoice)',
        href: '/draft-invoices',
        icon: FileText,
      },
      {
        key: 'operations_petty_cash',
        title: 'Petty Cash — เบิกหน้างาน',
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'system_admin', title: 'เมทริกซ์สิทธิ์ตามเมนู (Menu × Role)', href: '/system-admin/menu-permissions', icon: LockKeyhole },
